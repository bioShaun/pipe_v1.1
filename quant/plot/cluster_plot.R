...
theme_set(my_theme)
#output_path <- './'
#file_path <- '/media/zxchen/3dddd6c4-2700-41a5-a677-15b165fa4e64/project/mRNA/2017/OM-mRNA-5-Wheat-wangjingyi-P20170303/part2/OM-mRNA-5-Wheat_part2/mRNA_analysis_results/differential_analysis/cluster/clusters_fixed_P_10'
